    ...
    <div name="about" className="w-full mt-8 lg:mt-28 p-2">
      <div className="max-w-screen-lg p-6 mx-auto flex flex-col justify-center items-center h-full">
        <div ref={Animation("left","30px",200, 1000)}
            className="text-4xl font-bold inline border-b-4 border-rose-800 text-rose-600 lg:text-6xl items-center mb-6"
          >
            About me
        </div>
        <div className="flex flex-col-reverse lg:flex-row-reverse lg:mt-5">
          <div ref={Animation("right", "30px", 200, 2000)} className="text-lg lg:text-xl text-rose-700 lg:w-[30rem]">
            <div className="w-full text-sm lg:text-xl">
              <div className="mt-2">
                <p className="text-3xl mb-4 font-bold text-rose-800 lg:text-2xl">My Skills...</p>
          ...
          <div
            ...
            className="text-lg text-rose-600 lg:pr-6 lg:w-[30rem]"
          >
            <span className="text-2xl lg:text-4xl text-rose-800 font-bold">
            ...
            <div className="pt-2 text-base lg:text-xl">
              ...
              <ul className="text-rose-800 font-bold lg:text-3xl text-2xl"> Education:
                <p className="text-rose-600 lg:text-lg text-sm font-light">
                <li>Current CGPA: 7.65</li>
                <li>12th Grade: Kendriya Vidyalaya Mhow - 76.6%</li>
                <li>10th Grade: Kendriya Vidyalaya Mhow - 65.2%</li>
                </p>
              </ul>
              <ul className="text-rose-800 lg:text-3xl font-bold text-2xl"> Hobbies:
                <p className="text-rose-600 lg:text-lg text-sm font-light">
