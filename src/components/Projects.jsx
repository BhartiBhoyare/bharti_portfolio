...
const Projects = () => {
  const pro = [
    {
      ...
      link: "https://bharti-task-management.vercel.app/",
      skill1: <FaReact />,
      skill2: <IoLogoNodejs />,
      skill3: <BiLogoMongodb />,
      skill4: <FaJsSquare />,
      skill5: <SiExpress />,
      skill6: <RiTailwindCssFill />,
    },
    {
      id: 2,
      src: foodies,
  ...
  return (
    <div
      name="projects"
      className="w-full mt-14 h-[95vh] lg:mt-4 p-2 xl:h-[38.4rem]"
    >
      <div className="xl:max-w-screen-lg mx-auto flex flex-col md:justify-center items-center h-full">
        ...
        <div
          className="overflow-y-auto scrollbar-none h-[60vh] lg:w-full w-[14rem] md:w-[50%] grid grid-cols-1 lg:grid-cols-3 gap-4 xl:gap-8 text-center pt-6 lg:pl-10 lg:px-0"
          ...
          {pro.map(
            ({
              ...
              <div key={id} className={`shadow-md pb-2 rounded-lg ${style}`}>
                ...
                />
                <p className="lg:mt-4 text-sm md:text-xl my-1 md:my-2">
                  {title}
                </p>

                <div className="flex justify-between mt-2 px-6 md:px-8 mb-2">
                  <div className="flex space-x-2">
                    ...
                    <span className="w-6 xl:size-8">{skill6}</span>
                  </div>
